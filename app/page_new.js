    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <motion.div
          ...
          className="p-6 bg-gradient-to-br from-blue-500/10 to-blue-600/10 rounded-lg border border-blue-500/20"
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-300">Total de Tarefas</p>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="p-6 bg-gradient-to-br from-yellow-500/10 to-orange-600/10 rounded-lg border border-yellow-500/20"
        >
          <div className="flex items-center gap-3">
        ...
        <motion.div
          ...
          className="p-6 bg-gradient-to-br from-green-500/10 to-emerald-600/10 rounded-lg border border-green-500/20"
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-300">Concluídas</p>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="p-6 bg-gradient-to-br from-pink-500/10 to-red-600/10 rounded-lg border border-pink-500/20"
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-300">Favoritas</p>
            </div>
          </div>
        </motion.div>
      </div>
