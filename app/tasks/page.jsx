...
import TasksByColorChart from '@/components/TasksByColorChart';
import TaskCompletionChart from '@/components/TaskCompletionChart';
import TaskTrendChart from '@/components/TaskTrendChart';
import TaskProductivityChart from '@/components/TaskProductivityChart';
...
export default function TasksPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      {/* Search, Sort and Filters - Single Row */}
      <div className="flex flex-col xl:flex-row gap-4 p-4 bg-[#1e1e1e] rounded-lg border border-[#2f2f2f]">
        {/* Search Bar */}
        <div className="relative xl:flex-1 xl:max-w-md">
          <Search
            size={20}
        ...
        <div className="xl:min-w-[180px]">
          <select
            ...
            className="w-full px-3 py-2.5 bg-[#2f2f2f] border border-[#404040] rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none text-sm"
          >
        ...
        {showCharts && tasks.length > 0 && (
          ...
          >
            <motion.div
              ...
              className="bg-[#121212] rounded-xl border border-[#2f2f2f] shadow-2xl max-w-7xl w-full max-h-[90vh] overflow-auto"
            ...
            >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-xl font-bold bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">
                      Analytics Avançado das Tarefas
                    </h2>
                    <p className="text-gray-400 text-sm">
                      Análise detalhada com múltiplos gráficos
                    </p>
                  </div>
                </div>
                <button
              ...
              <div className="p-6 space-y-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  <TasksByColorChart tasks={tasks} />
                  <TaskCompletionChart tasks={tasks} />
                </div>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  <TaskTrendChart tasks={tasks} />
                  <TaskProductivityChart tasks={tasks} />
                </div>
              </div>
              ...
              <div className="p-6 border-t border-[#2f2f2f] bg-[#1a1a1a] rounded-b-xl">
                <div className="flex items-center justify-between">
                  <p className="text-sm text-gray-400">
                    4 gráficos interativos • {tasks.length} tarefas analisadas •
                    Dados em tempo real
                  </p>
                  <button
                    onClick={() => setShowCharts(false)}
